<?php
print "<B><U>Constructores (ejemplo c821.php)</U></B><BR><BR>";
...
class ClaseBase {
	...
	function __construct() {
	    print "Éste es el constructor de la clase base ClaseBase<BR>";
	}
}	
...
class ClaseHija1 extends ClaseBase {
	...
	function __construct() {
	    print "Éste es el constructor de la clase hija ClaseHija1<BR>";
		// aquí se podría llamar explícitamente al constructor de la clase
		// base
	}
}	
...
class ClaseHija2 extends ClaseBase {
	...
	// observar que se utiliza la vieja sintaxis para hacer referencia
	// al constructor, es decir, se usa el nombre de la propia clase
	// esto es igual a haber codificado lo siguiente:
	// function __construct(){ 
	// se recomienda utilizar el nombre de método __construct() 
	function ClaseHija2() {
	    print "Éste es el constructor de la clase hija ClaseHija2<BR>";
		// aquí se llama explìcitamente al constructor de la clase base 
		parent::__construct();
	}
}	
