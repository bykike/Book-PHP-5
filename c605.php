<?php
print "<B><U>Prácticas con función strcasecmp() para comparar cadenas  (ejemplo c605.php)</U></B><BR>";
...
imprimir('ABC','abc'); // no hace diferencia de mayúsculas y minúsculas
