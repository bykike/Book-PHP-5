<?php
print "<B><U>Sentencia while (ejemplo c405.php)</U></B><BR>";
...
while ($var1 <= 3) {
	...
	// tendiese a alejarse de la condición falsa, por ejemplo, si en lugar
	// de sumar 1 se restase 1. $var1 sería 1, 0, -1, -2, etc. nunca
	// llegaría a 3.
     print "1er.while " . $var1++ . "<BR>";  //post incremento
	 
}
// observar en la salida impresa que $var1 sale de la sentencia while 
