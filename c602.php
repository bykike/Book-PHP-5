<?php
print "<B><U>Prácticas con funciones para buscar en cadenas (ejemplo c602.php)</U></B><BR>";
...
// no encontrará nada porque no la función strrchr() hace diferencia entre 
...
// strrchr() busca la última aparición del primer carácter de la cadena de búsqueda
// el resto de la cadena no se toma en cuenta, es decir 'HOY' es lo mismo que poner 'H' 
...
// no encontrará nada porque no la función strpos() hace diferencia entre 
// mayúsculas y minúsculas
