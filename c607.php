<?php
print "<B><U>Prácticas con funciones para trabajar con subcadenas cadenas  (ejemplo c607.php)</U></B><BR>";
...
// la posición de inicio puede ser negativa (significa que se cuenta desde el final)
...
$var2 = str_replace("USA","EEUU",$var1); // cambia el texto (pero diferencia mayúsculas de minúsculas)
print "cadena:$var2 <BR>";

// la función strtr(pcadena, pbusca, preemplaza)
// reemplaza los caracteres de pbusca por el correspondiente en preemplaza
...
// la matriz, las claves tiene los datos a traducir y los valores son los reemplazosPrint "<BR><B>Función strtr()formato alternativo</B><BR>";
