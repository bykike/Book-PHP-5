...
function conectar()
{
	$this->strcon = mysql_connect("localhost","root","pswroot") or die("Error de aplicación: No conectó con la base de datos");
	$result = mysql_select_db("licenciadb",$this->strcon) or die ("Error de aplicación: No seleccionó la base de datos");;
}
