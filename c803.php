<?php
print "<B><U>Diferencia entre público y privado (ejemplo c803.php)</U></B><BR><BR>";
...
class MiClase {
	...
	function metPublic2($texto) {
		// este método lo puedo llamar desde una clase derivada de MiClase 
		$this->metPrivate($texto);
		print "Estoy dentro del método metPublic2<BR><BR>";
		print "Desde dentro de la clase puedo visualizar la variable priva: " .$this->priva . "<BR><BR>";
	}
}	
