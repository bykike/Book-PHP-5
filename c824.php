<?php
print "<B><U>Comparación de objetos (ejemplo c824.php)</U></B><BR><BR>";
...
// pero la realidad es que lo importante es que son clases diferentes
class Prueba2 {
	public $contador;
...
$o2 = new Prueba;
$o3 = $o1;
// la clase Prueba2 es idéntica en contenido de propiedades y métodos a la clase Prueba
...
// o1 y 03 son dos referencias al mismo ejemplar (obviamente, de la misma clase)
if ($o1 == $o3){
