<?php
print "<B><U>__autoload() (ejemplo c829.php)</U></B><BR><BR>";

// Éste es un modo de hacerlo sin __autoload()
//include_once "Personas.php";

function __autoload($varClase) {
	// con este print veremos cuántas veces se invoca a la función autoload()
...
// la clase Persona no está declarada dentro de la secuencia de comandos vigente
// en lugar de producirse un error, la unción __autoload lo intercepta
// y se ejecuta. El parámetro que recibe la función es el nombre de la clase
// que no está definida en el script
$obj = new Persona(122,"José Pérez");
$obj->listar();

// como la clase Empleado está definida dentro del archivo Personas.php
// cuando se hace referencia a la clase Empleado, PHP detecta que la clase ya 
