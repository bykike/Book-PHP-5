<?php
print "<B><U>Prácticas con funciones para trabajar con HTML(ejemplo c612.php)</U></B><BR>";

// htmlentities(pcadena)
// devuelve una cadena convirtiendo  caracteres que deben reemplazarse por entidades HTML
...
print $var2 . "<BR>"; // Conversión: A es id&eacute;ntico a B y &gt; a C pero &lt; a D
...
print "Cadena original: <B> $var1 </B><BR>";
print "Longitud de la cadena original: " . strlen($var1) . " caracteres<BR>";
print "$var2<BR>"; // Conversión:  Pérez &amp; co. (La e acentuada no cambia)) 
print "Longitud es ". strlen($var2) . " (ver la conversión en el comentario del programa)<BR>";
...
// html_entity_decode() convierte las entidades HTML a los caracteres de origen
// es la inversa a htmlentities() 
$var1 = "áéíoú&<>"; // algunos de los caracteres que se convierten a entidades HTML 
