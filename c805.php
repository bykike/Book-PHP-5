<?php
print "<B><U>Acceso a una función miembro estático  (ejemplo c805.php)</U></B><BR><BR>";
...
Print "Longitud de la circunferencia (con instancia) : " . $obj->longitud_circunferencia(44.5);  
