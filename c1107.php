<?php
Print "<B>Funciones para tratamiento de directorios (ejemplo c1107.php) </B><BR>";

print "<BR><B>1. Extrae el nombre de archivo a partir de una ruta de acceso: función basename()</B><BR>";
$arch = "C:\Archivos de programa\wampserver\www\ejemplos\archivo01.txt";
...
$var = opendir("C:\Archivos de programa\wampserver\www");
