<?php
print "<B><U>Prácticas con función strncmp()para comparar cadenas (ejemplo c606.php)</U></B><BR>";
...
// el tercer parámetro es la cantidad de caracteres que se compararán
imprimir('abc','abcdef',3); // dará igual porque compara los 3 primeros
