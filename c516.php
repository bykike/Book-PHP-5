<?php
print "<B><U>Añadir elementos con array_intersect_assoc() (ejemplo c516.php)</U></B><BR><BR>";
...
// el valor España está en ambas matrices, pero con distinto orden (clave) 
$mat3 = array_intersect_assoc($mat1,$mat2);
 
print "Contenido actual de la matriz: cantidad de elementos :" . count($mat3) . "<BR><BR>";
// observar que los valores de clave se mantienen
// 2 para Escocia 
print_r ($mat3); 
