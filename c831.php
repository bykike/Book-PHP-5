<?php
print "<B><U>Varias funciones para tratar con clases y objetos (ejemplo c831.php)</U></B><BR><BR>";
...
print  "<BR><B>5. Función get_declared_classes(). </B>Éstas son las clases definidas : ";
print_r  (get_declared_classes()) ;

// Función get_object_vars()
print  "<BR><B>6. Función get_object_vars(). </B>Éstas son las propiedades del objeto \$emp : ";
print_r (get_object_vars($emp)) ;
 
// Función get_parent_class() 
print  "<BR><B>7. Función get_parent_class(). </B>Ésta es la clase base del objeto \$emp : " . get_parent_class($emp);

// Función getType()
print  "<BR><B>8. Función getType(). </B>Éste es el tipo de la variable \$emp: " . gettype($emp);

// Función is_a()
if (is_a($emp,"Empleado")){
	print "<BR><B>9. Función is_a(). </B>El objeto \$emp pertenece a la clase Empleado.";
}

// Función is_subclass_of()
if (is_subclass_of($emp,"Persona")){
	print "<BR><B>10. Función is_subclass_of(). </B>El objeto \$emp es subclase de la clase Persona.";
}

// Función method_exists()
if (method_exists($emp,"Listar")){
	print "<BR><B>11. Función method_exists(). </B>El objeto \$emp contiene el método Listar.";
}

// Función setType()
$vardbl = 23;
settype($vardbl,"double");
print  "<BR><B>12. Función setType(). </B>Éste es el tipo de la variable \$vardbl: " . gettype($vardbl);
?>