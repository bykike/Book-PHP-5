<?php
print "<BR><B><U> Gestor de errores personalizado (ejemplo c1601.php) <BR></B></U>";
                                  ...
                                  $linea_error, $contexto_error)
{
    ...
    switch ($num_error) {
      	case E_USER_ERROR:
			...
			error_log($err, 3, "c://Archivos de programa/wampserver/apache/logs/error.log");
...
//Establecer un gestor de errores de usuario
...
// En este caso, como el servidor MySQL está detenido
