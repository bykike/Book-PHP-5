<?php
print "<B><U>Destructores (ejemplo c822.php)</U></B><BR><BR>";
...
class ClaseBase {
	...
	function __destruct() {
	    print "Éste es el destructor de la clase base ClaseBase<BR>";
	}
}	
...
class ClaseHija1 extends ClaseBase {
	...
	function __destruct() {
	    print "Llamada automática al destructor de la clase hija ClaseHija1<BR>";
		// aquí se podría llamar explícitamente al destructor de la clase
		// base
	}
}	
...
class ClaseHija2 extends ClaseBase {
	...
	function __destruct() {
	    print "Llamada automática al destructor de la clase hija ClaseHija2<BR>";
		// aquí se llama explìcitamente al destructor de la clase base 
		print "<B>Atención:</B>Llamada explícita desde la clase hija ClaseHija2<BR>";
		parent::__destruct();
	}
}	
