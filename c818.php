<?php
print "<B><U>Simulación de sobrecarga de métodos (ejemplo c818.php)</U></B><BR><BR>";
...
print "Método test: proceso con argumento numérico: " . $a->resultado . "<BR>"; 

$a->test("Esto "); // se usa el método test con cadenas
print "Método test: proceso con argumento de cadena: " . $a->resultado . "<BR>"; 
?>