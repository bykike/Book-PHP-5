<?php
print "<B><U>Prácticas con funciones para convertir cadenas  (ejemplo c608.php)</U></B><BR>";
...
$var1 = str_split("abcdefghijk"); // asume que cada elemento tiene longitud 1  
print_r ($var1); 

Print "<BR><BR><B>Función str_split(): con parámetro de longitud</B><BR>";
$var1 = str_split("PHP es un lenguaje fácil",3); // cada elemento tiene longitud 3 
print_r ($var1);   
...
// convierte el primer carácter de una cadena a mayúsculas (si es alfabético))
