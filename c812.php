<?php
print "<B><U>Interfaces (ejemplo c812d.php)</U></B><BR><BR>";
...
print "pero también es de tipo Persona (por derivar de esta clase).<BR>";}
if ($emp instanceof Imprimir) {
print "Y también es de tipo Imprimir (por implementar esta interfaz).<BR>";}
