<?php
print "<B><U>Comprobación de tipos (ejemplo c815.php)</U></B><BR><BR>";
...
class Factura {
	...
	function agregar_línea($línea_detalle) {
		if ($línea_detalle instanceof Línea_Detalle){
	   		$this->líneas[] = $línea_detalle;
		} else {
			print "Error detectado: Parámetro debe ser de tipo Línea_Detalle <BR>";
		}
	}
...
$fac->agregar_línea(12, "manzanas"); // ¡PERO NO SE ENVÏA UN OBJETO LÍNEA_DETALLE! 
...
foreach (($fac->obtener_líneas()) as $value){ 
	print  ("cantidad: " . $value->cantidad . " unidades -  producto: " .$value->producto . "<BR>");
}	
