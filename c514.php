<?php
print "<B><U>Añadir elementos con array_unshift() y con array_pad() (ejemplo c514.php)</U></B><BR><BR>";
$mat1 = array("Bélgica", "Escocia", "España");
print "Contenido original de la matriz: cantidad de elementos :" . count($mat1) . "<BR>";
print_r ($mat1); 
...
print "Resultado: cantidad de elementos :" . $var1 . "<BR>>";
print_r ($mat1); 
...
//			devuelve una matriz igual que la de entrada (sin cambios ni eliminaciones) 
...
//
// añadir por la cola elementos de relleno constantes hasta llegar a 7 elementos
$mat2 = array_pad ($mat1,7,"A definir");
print "<BR><BR><B>Uso función array_pad() (relleno por la cola) </B><BR>";
print "Resultado: cantidad de elementos :" . count($mat2) . "<BR>";
print_r ($mat2);

// añadir por adelante elementos de relleno constantes hasta llegar a 9 elementos
$mat3 = array_pad ($mat2,-9,"A definir");
print "<BR><BR><B>Uso función array_pad()(relleno por el inicio)</B><BR>";
print "Resultado: cantidad de elementos :" . count($mat3) . "<BR>";
print_r ($mat3);  
