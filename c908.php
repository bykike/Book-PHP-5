...
<HTML>
	...
	<BODY>
		<CENTER>
					...
					<TR>
						...
						<TD ALIGN='LEFT'>
							<SELECT name='aplicación'>
						        ...
						        <OPTION value='Usuario Web'>Usuario Web</OPTION>
						</TD>
					</TR>
				</TABLE>	
			...
			// En caso contrario, se procesa la respuesta al cliente
			else {
