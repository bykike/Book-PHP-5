<?php
print "<B><U>Prácticas con marcado de caracteres especiales (ejemplo c611.php)</U></B><BR>";

// addslashes(pcadena)
// devuelve una cadena con barras invertidas para marcar los caracteres
// que se deben enmascarar  
$var1 = " D'Andrea\Edgar\"";
...
// addcslashes es más flexible ya que permite definir una lista de los caracteres
// que se quieren enmascarar en el segundo parámetro 
// hace diferencia entre mayúsculas y minúsculas (p.ej., a<>A )
$var2 = addcslashes($var1,"DAndre"); // añade barras invertidas a las letras que se definen en el parámetro
...
Print "¿Qué sucedió? ¿No es lo esperado?";
Print "Atención ¡lo que reconoce como símbolos enmascarados los reemplaza por los símbolos correspondientes!";
